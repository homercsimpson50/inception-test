...
**YOU ARE IN: `inception/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/inception/` (rig root) or other directories
...
**Your mail address:** `inception/polecats/rust`
**Your rig:** inception
**Your Witness:** `inception/witness`
...
| Ask Witness for help | `gt mail send inception/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`inception/witness`) when:
...
```bash
gt mail send inception/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
